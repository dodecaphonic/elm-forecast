...
Elm.Forecast.make = function (_elm) {
   "use strict";
   _elm.Forecast = _elm.Forecast || {};
   if (_elm.Forecast.values)
   ...
   $moduleName = "Forecast",
   $Basics = Elm.Basics.make(_elm),
   $Forecast$DarkSky = Elm.Forecast.DarkSky.make(_elm),
   $Forecast$DarkSkySignal = Elm.Forecast.DarkSkySignal.make(_elm),
   $Forecast$Location = Elm.Forecast.Location.make(_elm),
   ...
   var completeForecast = function (cf) {
      return function () {
         ...
         {case "Just":
            return A2($Html.div,
              _L.fromArray([]),
              _L.fromArray([$Html.text("something")]));
            case "Nothing":
            return A2($Html.div,
              _L.fromArray([]),
   ...
   forecast) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([completeForecast(forecast)]));
   });
   var noLocationSelected = A2($Html.div,
   _L.fromArray([]),
   _L.fromArray([$Html.text("Please select a location.")]));
   var weatherView = F2(function (location,
   forecast) {
      return function () {
         switch (location.ctor)
         {case "Just":
            return A2(selectedLocation,
              location._0,
              forecast);
            case "Nothing":
   ...
   model) {
      return function () {
         ...
         {case "NoOp": return model;
            case "SelectLocation":
            return function () {
                 var updateSelection = function (loc) {
                    return _U.replace([["isSelected"
                                       ,_U.eq(loc.id,action._0)]],
                    loc);
                 };
...
Elm.Forecast = Elm.Forecast || {};
Elm.Forecast.DarkSky = Elm.Forecast.DarkSky || {};
Elm.Forecast.DarkSky.make = function (_elm) {
   "use strict";
   _elm.Forecast = _elm.Forecast || {};
   _elm.Forecast.DarkSky = _elm.Forecast.DarkSky || {};
   if (_elm.Forecast.DarkSky.values)
   return _elm.Forecast.DarkSky.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Forecast.DarkSky",
   $Basics = Elm.Basics.make(_elm),
   ...
   var forecastDecoder = A9($Json$Decode.object8,
   Forecast,
   A2($Json$Decode._op[":="],
   "time",
   $Json$Decode.$int),
   ...
   "windBearing",
   $Json$Decode.$float));
   var TimespanForecast = F3(function (a,
   b,
   c) {
      return {_: {}
             ,forecasts: c
   ...
   var completeForecastDecoder = $Json$Decode.maybe(A7($Json$Decode.object6,
   CompleteForecast,
   A2($Json$Decode._op[":="],
   "latitude",
   $Json$Decode.$float),
...
Elm.Forecast = Elm.Forecast || {};
Elm.Forecast.DarkSkySignal = Elm.Forecast.DarkSkySignal || {};
Elm.Forecast.DarkSkySignal.make = function (_elm) {
   "use strict";
   _elm.Forecast = _elm.Forecast || {};
   _elm.Forecast.DarkSkySignal = _elm.Forecast.DarkSkySignal || {};
   if (_elm.Forecast.DarkSkySignal.values)
   return _elm.Forecast.DarkSkySignal.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Forecast.DarkSkySignal",
   $Basics = Elm.Basics.make(_elm),
   $Forecast$DarkSky = Elm.Forecast.DarkSky.make(_elm),
   $Forecast$Location = Elm.Forecast.Location.make(_elm),
   ...
   var darkSky = F2(function (lat,
   lon) {
      return A2($Basics._op["++"],
      "http://localhost:9292/fetch/",
      A2($Basics._op["++"],
      $Basics.toString(lat),
      A2($Basics._op["++"],
      "/",
   ...
   var fetchOne = function (location) {
      return function () {
         var $ = $Maybe.withDefault({ctor: "_Tuple2"
                                    ,_0: -22.9068
                                    ,_1: -43.1729})(A2($Maybe.map,
         function (l) {
            return {ctor: "_Tuple2"
                   ,_0: l.latitude
                   ,_1: l.longitude};
         ...
         lon = $._1;
         return A2($Http.get,
         $Forecast$DarkSky.completeForecastDecoder,
         A2(darkSky,lat,lon));
      }();
   };
   var queryForecast = $Signal.mailbox($Maybe.Nothing);
   var newForecast = $Signal.mailbox($Maybe.Nothing);
   var fetchForecast = Elm.Native.Task.make(_elm).performSignal("fetchForecast",
   $Signal.map(function (task) {
      return A2($Task.andThen,
      task,
      $Signal.send(newForecast.address));
   })($Signal.map(fetchOne)(queryForecast.signal)));
   _elm.Forecast.DarkSkySignal.values = {_op: _op
                                        ,queryForecast: queryForecast
                                        ,newForecast: newForecast};
   return _elm.Forecast.DarkSkySignal.values;
};
Elm.Forecast = Elm.Forecast || {};
Elm.Forecast.Location = Elm.Forecast.Location || {};
Elm.Forecast.Location.make = function (_elm) {
   "use strict";
   _elm.Forecast = _elm.Forecast || {};
   _elm.Forecast.Location = _elm.Forecast.Location || {};
   if (_elm.Forecast.Location.values)
   return _elm.Forecast.Location.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Forecast.Location",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   _elm.Forecast.Location.values = {_op: _op
                                   ,Location: Location};
   return _elm.Forecast.Location.values;
};
